 ...
 */
public class FundAppWidget extends AppWidgetProvider {
    ...
    public void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Intent refreshIntent = new Intent(context,FundAppWidget.class);
    ...
    private void queryFund(Context context,QueryBean queryBean){
        ...
        ComponentName mComponentName = new ComponentName(context, FundAppWidget.class);
    ...
    public void szFund(SzFundBean szFundBean,Context context){
        ...
        appWidgetManger.updateAppWidget(new ComponentName(context, FundAppWidget.class), views);
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(@NotNull Message msg) {
            ...
            if (msg.what == START_ANIMATION) {
                ...
                appWidgetManger.updateAppWidget(new ComponentName(mContext, FundAppWidget.class), views);
                //循环图片
                num++;
