...
public class RxUtils {
    ...
    public static <T> ObservableTransformer<T, T> applySchedulersNoLoading(final IView view) {
        return observable -> observable.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .compose(RxLifecycleUtils.bindToLifecycle(view));
    }

    public static <T> FlowableTransformer<T, T> applyFlowableSchedulers(final IView view) {
        //隐藏进度条
    ...
    public static <T> FlowableTransformer<T, T> applyFlowableSchedulersNoLoading(final IView view) {
        return flowable -> flowable.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .compose(RxLifecycleUtils.bindToLifecycle(view));
    }
